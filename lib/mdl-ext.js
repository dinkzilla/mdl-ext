...
/***/ function(module, exports) {
	 ...
	 * @return {function(...[*]=)}
	 */
	var throttledFunction = function throttledFunction(callback) {
	...
	exports.default = throttledFunction;
	module.exports = exports["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _throttledFunction = __webpack_require__(20);
	
	var _throttledFunction2 = _interopRequireDefault(_throttledFunction);
	...
	(function () {
	  ...
	  MaterialExtLightbox.prototype.init = function () {
	    ...
	    if (this.element_) {
	      ...
	      window.addEventListener('resize', (0, _throttledFunction2.default)(function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  var throttleResize = (0, _throttledFunction2.default)(function (self) {
	  ...
	  var throttleScroll = (0, _throttledFunction2.default)(function (self) {
	...
	(function (window, document) {
	  ...
	  var ResizeObserver = function () {
	    ...
	    (0, _createClass3.default)(ResizeObserver, [{
	      ...
	      key: 'populateActiveTargets_',
	      value: function populateActiveTargets_() {
	        this.activeTargets_ = this.observationTargets_.filter(function (resizeObervation) {
	          return resizeObervation.target && resizeObervation.target.parentNode && resizeObervation.isActive();
	        });
	      }
	    }, {
	      key: 'broadcast_',
	  ...
	  var ResizeController = function ResizeController() {
	    ...
	    var rafLoop = new _animationloop2.default();
