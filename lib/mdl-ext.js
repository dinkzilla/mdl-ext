...
/***/ function(module, exports, __webpack_require__) {
	...
	var _apply = __webpack_require__(59);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (window, document) {
	  ...
	  var MAX_DEPTH = 65535; // Infinity, kind of :)
	
	  var isOrphan = function isOrphan(target) {
	  ...
	  var getContentRect = function getContentRect(target) {
	    ...
	    if (!isOrphan(target)) {
	      ...
	      result.width = r.width - (result.left + (parseFloat(cs.paddingRight) || 0) + (parseFloat(cs.marginLeft) || 0) + (parseFloat(cs.marginRight) || 0) + (parseFloat(cs.borderLeftWidth) || 0) + (parseFloat(cs.borderRightWidth) || 0));
	      result.height = r.height - (result.top + (parseFloat(cs.paddingBottom) || 0) + (parseFloat(cs.marginTop) || 0) + (parseFloat(cs.marginBottom) || 0) + (parseFloat(cs.borderTopWidth) || 0) + (parseFloat(cs.borderBottomWidth) || 0));
	    }
	    return result;
	  };
	   ...
	   */
	  var depthOfNode = function depthOfNode(target) {
	  ...
	  var ResizeObserver = function () {
	    ...
	    (0, _createClass3.default)(ResizeObserver, [{
	      ...
	      key: 'gatherActiveObservationsAtDepth_',
	      value: function gatherActiveObservationsAtDepth_() {
	        ...
	        */
	        ...
	        this.activeTargets_ = [];
	        this.skippedTargets_ = [];
	        var index = this.observationTargets_.length - 1;
	        while (index > -1) {
	          var resizeObservation = this.observationTargets_[index];
	
	          if (resizeObservation.isOrphan) {
	            this.observationTargets_.splice(index, 1);
	          } else if (resizeObservation.isActive) {
	            var targetDepth = depthOfNode(resizeObservation.target);
	      ...
	      key: 'broadcastActiveObservations_',
	      value: function broadcastActiveObservations_() {
	        if (this.activeTargets_.length > 0) {
	          var shallowestTargetDepth = MAX_DEPTH;
	          var entries = [];
