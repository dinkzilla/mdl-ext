...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.randomString = exports.joinStrings = undefined;
	...
	var joinStrings = function joinStrings() {
	  ...
	  var joinStrings = function joinStrings(a, b) {
	    return a ? '' + a + delimiter + b : b;
	  };
	
	  var toString = function toString(prevString, arg) {
	    return isString(arg) ? joinStrings(prevString, arg) : (0, _keys2.default)(arg).filter(function (key) {
	      return arg[key];
	    }).reduce(function (result, key) {
	      return joinStrings(result, key);
	    }, prevString);
	  };
