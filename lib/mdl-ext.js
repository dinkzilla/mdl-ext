...
/***/ function(module, exports) {
	...
	var intervalFunction = function intervalFunction() {
	  var interval = arguments.length <= 0 || arguments[0] === undefined ? MIN_INERVAL : arguments[0];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _intervalFunction = __webpack_require__(19);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fullThrottle = __webpack_require__(18);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  var MENU_BUTTON_BUTTON = 'mdlext-menu-button__button';
	  var MENU_BUTTON_MENU = 'mdlext-menu-button__menu';
	  var MENU_BUTTON_MENU_ITEM = 'mdlext-menu-button__menu__item';
	  ...
	  MaterialExtMenuButton.prototype.openMenu = function () {
	    var position = arguments.length <= 0 || arguments[0] === undefined ? 'first' : arguments[0];
	  ...
	  MaterialExtMenuButton.prototype.upgrade = function () {
	    ...
	    var addWaiAria = function addWaiAria() {
	      ...
	      var buttonId = void 0;
	      if (!_this.button_.hasAttribute('id')) {
	        buttonId = 'menu-button-button-' + (0, _stringUtils.randomString)();
	        _this.button_.id = buttonId;
	      } else {
	        buttonId = _this.button_.id;
	      }
	
	      if (!_this.button_.hasAttribute('tabindex')) {
	        _this.button_.setAttribute('tabindex', '0');
	      }
	
	      _this.button_.setAttribute('role', 'button');
	
	      if (!_this.button_.hasAttribute('aria-expanded')) {
	        _this.button_.setAttribute('aria-expanded', 'false');
	      }
	
	      if (_this.menu_) {
	        _this.button_.setAttribute('aria-haspopup', 'true');
	
	        var menuId = void 0;
	        if (!_this.menu_.hasAttribute('id')) {
	          menuId = 'menu-button-menu-' + (0, _stringUtils.randomString)();
	          _this.menu_.id = menuId;
	        } else {
	          menuId = _this.menu_.id;
	        }
	
	        _this.button_.setAttribute('aria-controls', menuId);
	        _this.menu_.setAttribute('aria-labelledby', buttonId);
	
	        _this.menu_.setAttribute('tabindex', '-1');
	        _this.menu_.setAttribute('role', 'menu');
	
	        if (_this.button_.getAttribute('aria-expanded').toLowerCase() === 'false') {
	          _this.menu_.setAttribute('hidden', '');
	        } else {
	          _this.menu_.removeAttribute('hidden');
	        }
	
	        [].concat((0, _toConsumableArray3.default)(_this.menu_.querySelectorAll('.' + MENU_BUTTON_MENU_ITEM))).forEach(function (menuitem) {
	          menuitem.setAttribute('tabindex', '-1');
	          menuitem.setAttribute('role', 'menuitem');
	        });
	      } else {
	        _this.button_.setAttribute('aria-haspopup', 'false');
	      }
	    };
	
	    var buttonKeyDownHandler = function buttonKeyDownHandler(event) {
	    ...
	    var buttonFocusHandler = function buttonFocusHandler() {
	      _this.element_.classList.add(_constants.IS_FOCUSED);
	    };
	
	    var buttonBlurHandler = function buttonBlurHandler() {
	      _this.element_.classList.remove(_constants.IS_FOCUSED);
	    };
	    ...
	    var removeAllAriaSelected = function removeAllAriaSelected() {
	      [].concat((0, _toConsumableArray3.default)(_this.menu_.querySelectorAll('.' + MENU_BUTTON_MENU_ITEM + '[aria-selected="true"]'))).forEach(function (selectedItem) {
	        return selectedItem.removeAttribute('aria-selected');
	      });
	    };
	
	    var addAriaSelected = function addAriaSelected(item) {
	    ...
	    var menuKeyDownHandler = function menuKeyDownHandler(event) {
	      ...
	      switch (event.keyCode) {
	        ...
	        case _constants.VK_ARROW_LEFT:
	          ...
	          if (!n) {
	            n = _this.menu_.lastElementChild;
	          }
	          n.focus();
	          break;
	        ...
	        case _constants.VK_ARROW_RIGHT:
	          ...
	          if (!n) {
	            n = _this.menu_.firstElementChild;
	          }
	          n.focus();
	          break;
	    ...
	    var menuClickHandler = function menuClickHandler(event) {
	      if (event.target !== _this.menu_) {
	    ...
	    var menuBlurHandler = function menuBlurHandler(event) {
	      if (!(_this.menu_.contains(event.relatedTarget) || _this.button_.contains(event.relatedTarget))) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (window, document) {
	  ...
	  var dimensionHasChanged = function dimensionHasChanged(target, lastWidth, lastHeight) {
	    ...
	    var width = _getContentRect.width;
	    var height = _getContentRect.height;
	  ...
	  var ResizeObservation = function ResizeObservation(target) {
	    ...
	    var width = _getContentRect2.width;
	    var height = _getContentRect2.height;
