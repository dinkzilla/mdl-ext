...
/***/ function(module, exports, __webpack_require__) {
	...
	var _apply = __webpack_require__(63);
...
/***/ function(module, exports) {
	...
	var removeChildElements = function removeChildElements(element) {
	  var forceReflow = arguments.length <= 1 || arguments[1] === undefined ? true : arguments[1];
	...
	var isRectInsideWindowViewport = function isRectInsideWindowViewport(_ref) {
	  ...
	  var viewportWidth = _getWindowViewport.viewportWidth;
	  var viewportHeight = _getWindowViewport.viewportHeight;
	...
	var tether = function tether(controlledBy, element) {
	  ...
	  var viewportWidth = _getWindowViewport2.viewportWidth;
	  var viewportHeight = _getWindowViewport2.viewportHeight;
	  ...
	  var dy = controlRect.top - menuRect.top;
	  var dx = controlRect.left - menuRect.left;
	
	  // Menu rect, window coordinates relative to top,left of control
	  var top = menuRect.top + dy;
	  var left = menuRect.left + dx;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _entries = __webpack_require__(61);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var menuFactory = function menuFactory(element, controlledBy) {
	  ...
	  var _open = function _open() {
	    ...
	    (0, _domUtils.tether)(controlledBy.element, element);
	  ...
	  (0, _createClass3.default)(MenuButton, [{
	    ...
	    value: function init() {
	      ...
	      var clickHandler = function clickHandler() {
	        if (!_this2.isDisabled()) {
	          if (_this2.element.getAttribute('aria-expanded').toLowerCase() === 'true') {
	            _this2.closeMenu();
	          } else {
	            _this2.openMenu('selected');
	          }
	      ...
	      var removeListeners = function removeListeners() {
	        _this2.element.removeEventListener('keydown', keyDownHandler);
	        _this2.element.removeEventListener('click', clickHandler);
	      };
	
	      var addListeners = function addListeners() {
	        _this2.element.addEventListener('keydown', keyDownHandler);
	        _this2.element.addEventListener('click', clickHandler);
	      };
	
	      var addWaiAria = function addWaiAria() {
	        _this2.element.setAttribute('role', 'button');
	      ...
	      var addFocusElement = function addFocusElement() {
	        _this2.focusElement = _this2.element.querySelector('input[type="text"]');
	        if (!_this2.focusElement) {
	          _this2.focusElement = _this2.element;
	
	          if (!(_this2.focusElement.tagName.toLowerCase() === 'button' || _this2.focusElement.tagName.toLowerCase() === 'input')) {
	            if (!_this2.focusElement.hasAttribute('tabindex')) {
	              _this2.focusElement.setAttribute('tabindex', '0');
	            }
	          }
	        }
	      };
	      ...
	      var findMenuElement = function findMenuElement() {
	        ...
	        var menuElementId = _this2.element.getAttribute('aria-controls');
	        if (menuElementId !== null) {
	          menuElement = document.querySelector('#' + menuElementId);
	        } else {
	          menuElement = _this2.element.parentNode.querySelector('.' + MENU_BUTTON_MENU);
	        }
	        return menuElement;
	      };
	      ...
	      var addMenu = function addMenu() {
	        ...
	        _this2.menu = menuFactory(menuElement, _this2);
	        _this2.element.setAttribute('aria-controls', _this2.menu.element.id);
	      };
	    ...
	    value: function openMenu() {
	      ...
	      if (!this.isDisabled()) {
	        ...
	        this.scrollElements.forEach(function (el) {
	          return el.addEventListener('scroll', _this3.closeMenuHandler);
	        });
	    ...
	    value: function closeMenu() {
	      ...
	      var forceFocus = arguments.length <= 0 || arguments[0] === undefined ? false : arguments[0];
	
	      this.scrollElements.forEach(function (el) {
	        return el.removeEventListener('scroll', _this4.closeMenuHandler);
	      });
	    ...
	    key: 'dispatchSelect',
	    value: function dispatchSelect(item) {
