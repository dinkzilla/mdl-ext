...
/***/ function(module, exports, __webpack_require__) {
	...
	var menuFactory = function menuFactory(element, controlledBy) {
	   ...
	   */
	  var offsetParents = function offsetParents(el) {
	    var elements = [];
	   ...
	   */
	  var commonOffsetAncestor = function commonOffsetAncestor(a, b) {
	    var parentsA = offsetParents(a);
	    var parentsB = offsetParents(b);
	   ...
	   */
	  var positionRelativeToTarget = function positionRelativeToTarget(target, el) {
	    var x = 0;
	    var y = 0;
	   ...
	   * @return {boolean}
	   */
	  var rectInsideWindowViewport = function rectInsideWindowViewport(rect) {
	    var top = rect.top;
	  ...
	  var tether = function tether() {
	    ...
	    var ancestor = commonOffsetAncestor(controlledBy.element, element);
	
	    var _positionRelativeToTa = positionRelativeToTarget(ancestor, controlledBy.element);
	
	    var x = _positionRelativeToTa.x;
	    var y = _positionRelativeToTa.y;
