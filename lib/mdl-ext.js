...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  MaterialExtLightboard.prototype.init = function () {
	    ...
	    var focus = function focus(slide) {
	      if (slide) {
	    ...
	    var emitSelectvent = function emitSelectvent(slide) {
	      _this.element_.dispatchEvent((0, _customEvent.createCustomEvent)('select', {
	        bubbles: true,
	        cancelable: true,
	        detail: { source: slide }
	      }));
	    ...
	    var keydownHandler = function keydownHandler(event) {
	      ...
	      if (event.keyCode === VK_TAB || event.keyCode === VK_ENTER || event.keyCode === VK_SPACE || event.keyCode === VK_END || event.keyCode === VK_HOME || event.keyCode === VK_ARROW_UP || event.keyCode === VK_ARROW_LEFT || event.keyCode === VK_ARROW_DOWN || event.keyCode === VK_ARROW_RIGHT) {
	        ...
	        if (event.target !== _this.element_) {
	          ...
	          var slides = _this.element_.children;
	          var nextSlide = null;
	          var n = _this.element_.childElementCount - 1;
	    ...
	    var clickHandler = function clickHandler(event) {
	      ...
	      if (event.target !== _this.element_) {
	        ...
	        [].concat((0, _toConsumableArray3.default)(_this.element_.children)) // Should I use querySelectorAll ???
