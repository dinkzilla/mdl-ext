...
/***/ function(module, exports, __webpack_require__) {
	...
	var menuFactory = function menuFactory(element) {
	  ...
	  var _open = function _open(controlElement) {
	    var position = arguments.length <= 1 || arguments[1] === undefined ? 'first' : arguments[1];
	  ...
	  var close = function close() {
	    ...
	    var relatedTarget = arguments.length <= 2 || arguments[2] === undefined ? null : arguments[2];
	    ...
	    this.closeMenuHandler = function (event) {
	      ...
	      if (event && event.detail) {
	        if (event.detail.item) {
	          ...
	          _this.dispatchSelect();
	        }
	        var t = event.detail.relatedTarget;
	        if (!t || t && t.closest('.' + JS_MENU_BUTTON) !== _this.element) {
