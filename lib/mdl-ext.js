...
/***/ function(module, exports, __webpack_require__) {
	...
	var menuFactory = function menuFactory(element) {
	  ...
	  var drag = function drag(touchItem, startY) {
	
	    var lastTouchedItem = touchItem;
	
	    var dragging = function dragging(event) {
	      var x = event.clientX || (event.touches !== undefined ? event.touches[event.touches.length - 1].clientX : 0);
	      var y = event.clientY || (event.touches !== undefined ? event.touches[event.touches.length - 1].clientY : 0);
	      var t = void 0;
	      try {
	    ...
	    var endDrag = function endDrag(event) {
	      ...
	      var x = event.clientX || (event.changedTouches !== undefined ? event.changedTouches[event.changedTouches.length - 1].clientX : 0);
	      var y = event.clientY || (event.changedTouches !== undefined ? event.changedTouches[event.changedTouches.length - 1].clientY : 0);
	      var t = void 0;
	      try {
	  ...
	  var maybeClose = function maybeClose(target) {
