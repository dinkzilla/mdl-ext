...
/***/ function(module, exports, __webpack_require__) {
	...
	var joinStrings = function joinStrings() {
	  ...
	  var reduceString = function reduceString(result, str) {
	    return isString(str) ? result ? '' + result + delimiter + str : str : (0, _keys2.default)(str).filter(function (key) {
	      return str[key];
	    }).reduce(function (result, key) {
	      return result ? '' + result + delimiter + key : key;
	    }, result);
	  };
	  ...
	  return strings.filter(function (str) {
	    ...
	    return reduceString(result, str);
	  }, '');
	};
