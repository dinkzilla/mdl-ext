...
/***/ function(module, exports, __webpack_require__) {
	...
	var menuFactory = function menuFactory(element, controlledBy) {
	  ...
	  var _open = function _open() {
	    ...
	    (0, _domUtils.tether)(controlledBy.focusElement, element);
	  ...
	  var blurHandler = function blurHandler(event) {
	    if (!(element.contains(event.relatedTarget) || controlledBy.element.contains(event.relatedTarget))) {
	      setTimeout(function () {
	        return close(false);
	      }, 0); // Find a better solution? Animation maybe??
	    }
	  };
	...
	var MenuButton = function () {
	  ...
	  (0, _createClass3.default)(MenuButton, [{
	    ...
	    value: function openMenu() {
	      ...
	      if (!this.isDisabled() && this.menu) {
	        ...
	        this.scrollElements.forEach(function (el) {
	          return el.addEventListener('scroll', _this2.closeMenuHandler);
	        });
	    ...
	    value: function closeMenu() {
	      ...
	      if (this.menu) {
	        this.scrollElements.forEach(function (el) {
	          return el.removeEventListener('scroll', _this3.closeMenuHandler);
	        });
	    ...
	    value: function init() {
	      ...
	      */
	      ...
	      var addMenu = function addMenu() {
	        ...
	        if (menuElement) {
	          _this4.menu = menuFactory(menuElement, _this4);
