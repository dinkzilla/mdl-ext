...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @todo move to utils
	 */
	var windowViewport = function windowViewport() {
	  return {
	 ...
	 * @todo move to utils
	 */
	var rectInsideWindowViewport = function rectInsideWindowViewport(_ref) {
	  var top = _ref.top;
	  var left = _ref.left;
	  var bottom = _ref.bottom;
	  var right = _ref.right;
	
	  var _windowViewport = windowViewport();
	
	  var viewportWidth = _windowViewport.viewportWidth;
	  var viewportHeight = _windowViewport.viewportHeight;
	 ...
	 * @todo move to utils
	 */
	var scrollParents = function scrollParents(el) {
	  var elements = [];
	...
	var menuFactory = function menuFactory(element, controlledBy) {
	   ...
	   * @todo move to utils
	   */
	  var tether = function tether() {
	    var controlRect = controlledBy.element.getBoundingClientRect();
	
	    // 1. will menu height fit inside window viewport?
	
	    var _windowViewport2 = windowViewport();
	
	    var viewportWidth = _windowViewport2.viewportWidth;
	    var viewportHeight = _windowViewport2.viewportHeight;
	...
	var MenuButton = function () {
	  ...
	  (0, _createClass3.default)(MenuButton, [{
	    ...
	    value: function init() {
	      ...
	      var addWaiAria = function addWaiAria() {
	        if (!_this2.element.hasAttribute('tabindex')) {
	          _this2.element.setAttribute('tabindex', '0');
	        }
