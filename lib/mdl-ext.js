...
/***/ function(module, exports, __webpack_require__) {
	...
	var MENU_BUTTON_MENU_ITEM_DIVIDER = 'mdlext-menu__item-divider';
	...
	var menuFactory = function menuFactory(element, controlledBy) {
	  ...
	  var isDivider = function isDivider(item) {
	    return item && item.classList.contains(MENU_BUTTON_MENU_ITEM_DIVIDER);
	  };
	  ...
	  var addWaiAria = function addWaiAria() {
	    ...
	    if (!element.hasAttribute('id')) {
	      element.id = 'button-menu-' + (0, _stringUtils.randomString)();
	    }
	...
	var MenuButton = function () {
	  ...
	  (0, _createClass3.default)(MenuButton, [{
	    ...
	    value: function init() {
	      ...
	      var removeListeners = function removeListeners() {
	        _this.element.removeEventListener('keydown', keyDownHandler);
	        _this.element.removeEventListener('click', clickHandler);
	      };
	
	      var addListeners = function addListeners() {
	        _this.element.addEventListener('keydown', keyDownHandler);
	        _this.element.addEventListener('click', clickHandler);
	      };
	      ...
	      var findMenuElement = function findMenuElement() {
	        ...
	        var menuElementId = _this.element.getAttribute('aria-controls');
	        if (menuElementId !== null) {
	          menuElement = document.querySelector('#' + menuElementId);
	        } else {
	          menuElement = _this.element.parentNode.querySelector('.' + MENU_BUTTON_MENU);
	        }
	        return menuElement;
	      };
	      ...
	      var addMenu = function addMenu() {
	        ...
	        _this.menu = menuFactory(menuElement, _this);
	        _this.element.setAttribute('aria-controls', _this.menu.element.id);
	      };
