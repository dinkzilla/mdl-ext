	...
	(function () {
	  ...
	  MaterialExtCarousel.prototype.dragHandler_ = function (event) {
	    ...
	    var endDrag = function endDrag(e) {
	      ...
	      _this3.element_.removeEventListener('mousemove', drag);
	      _this3.element_.removeEventListener('touchmove', drag);
	      window.removeEventListener('mouseup', endDrag);
	      _this3.element_.removeEventListener('touchend', endDrag);
