...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  var PANEL_CLASS = 'mdlext-accordion__panel';
	  var HEADER_CLASS = 'mdlext-accordion__panel__header';
	  var UPGRADED_CLASS = 'is-upgraded';
	  ...
	  MaterialExtAccordion.prototype.initPanels_ = function () {
	    ...
	    [].concat((0, _toConsumableArray3.default)(this.element_.querySelectorAll('.' + PANEL_CLASS))).forEach(function (panel) {
	  ...
	  function MaterialExtAccordionPanel(panel, ctx) {
	    ...
	    header.addEventListener('click', function (event) {
	      ...
	      if (panel.hasAttribute('open')) {
	        ...
	        var openPanel = ctx.element_.querySelector('.' + PANEL_CLASS + '[open]');
	        if (openPanel) {
	          openPanel.removeAttribute('open');
	          var h = openPanel.querySelector('.' + HEADER_CLASS);
	          if (h) {
	    ...
	    function focus(panel) {
	      var a = panel.querySelector('.' + HEADER_CLASS + ' a');
	      if (a) {
	        a.focus();
	      }
	    }
