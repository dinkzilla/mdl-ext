	...
	(function () {
	  ...
	  function MaterialExtAccordionPanel(panel, ctx) {
	    ...
	    function dispatchToggleEvent(state, source, target) {
	      var evt = new CustomEvent('toggle', {
	        bubbles: true,
	        cancelable: true,
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  MaterialExtLightbox.prototype.keyDownHandler_ = function (event) {
	    ...
	    if (event) {
	      if (event.keyCode === VK_ESC || event.keyCode === VK_END || event.keyCode === VK_HOME || event.keyCode === VK_ARROW_UP || event.keyCode === VK_ARROW_LEFT || event.keyCode === VK_ARROW_DOWN || event.keyCode === VK_ARROW_RIGHT) {
	  ...
	  MaterialExtLightbox.prototype.imgLoadHandler_ = function () /*event*/{
	    ...
	    var footerHeight = function footerHeight(footer, isSticky) {
	      return isSticky && footer ? footer.clientHeight : 0;
	    };
	    ...
	    var dialog = this.parentNode.nodeName === 'DIALOG' ? this.parentNode : null;
	    if (dialog) {
	      this.style.width = '';
	      var fh = footerHeight(this.querySelector('footer'), this.classList.contains(STICKY_FOOTER_CLASS));
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.S, 'Number', {isInteger: __webpack_require__(44)});
