...
/***/ function(module, exports, __webpack_require__) {
	...
	var accordionClass = '.mdlext-accordion';
	var accordionPanelClass = '.mdlext-accordion__panel';
	var accordionTitleClass = '.mdlext-accordion__panel__title';
	...
	function initAccordions() {
	  ...
	  var n = 0;
	  [].concat((0, _toConsumableArray3.default)(fromEl.querySelectorAll(accordionClass + ':not(.is-upgraded)'))).forEach(function (accordion) {
	...
	function initAccordion(accordionEl) {
	  ...
	  [].concat((0, _toConsumableArray3.default)(accordionEl.querySelectorAll(accordionTitleClass))).forEach(function (header) {
	    ...
	    header.addEventListener('click', function (event) {
	      ...
	      if (panel.hasAttribute('open')) {
	        ...
	        var openPanel = accordionEl.querySelector(accordionPanelClass + '[open]');
	        if (openPanel) {
	          openPanel.removeAttribute('open');
	          var h = openPanel.querySelector(accordionTitleClass);
	          if (h) {
	...
	function focus(panel) {
	  var a = panel.querySelector(accordionTitleClass + ' a');
	  if (a) {
	    a.focus();
	  }
	}
