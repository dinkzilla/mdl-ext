	  ...
	  MaterialExtLightboard.prototype.initLightboard_ = function () {
	    ...
	    this.element_.addEventListener('click', function (event) {
	      ...
	      if (event.target !== this) {
	        ...
	        [].concat((0, _toConsumableArray3.default)(this.children)).filter(function (panel) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	/**
	 * Responsive Lightbox
	 * Should comply with WAI-ARA spec: https://www.w3.org/TR/wai-aria-practices-1.1/#dialog_modal
	 */
	
	/* eslint no-unused-vars: 0 */
	
	var MaterialExtLightbox = function MaterialExtLightbox() {
	  (0, _classCallCheck3.default)(this, MaterialExtLightbox);
	};
	
	exports.default = MaterialExtLightbox;
